...
prog3 :: Program
prog3 = Prog(SBlock[ SAss (Ident "x") (EInt 1), SAss (Ident "soma") (EInt 0), SAss (Ident "c") (EInt 0), SdoWhile (SBlock[ SAss (Ident "soma") (EAdd (EVar (Ident "soma")) (EVar (Ident "c"))), SAss (Ident "c") (ESub (EVar (Ident "c")) (EInt 1))]) (EVar (Ident "c"))])
